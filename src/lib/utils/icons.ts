...
export const ENTITY_ICONS: EntityIcon[] = [
  ...
  { id: "elder_guardian", name: "Elder Guardian", path: "elder_guardian/elder_guardian.png", category: "Hostile" },
  ...
  { id: "illager_illusioner", name: "Illusioner", path: "illager/illusioner.png", category: "Hostile" },
  ...
  { id: "illager_vindicator", name: "Vindicator", path: "illager/vindicator.png", category: "Hostile" },
  { id: "phantom", name: "Phantom", path: "phantom/phantom.png", category: "Hostile" },
  { id: "piglin_brute", name: "Piglin Brute", path: "piglin/piglin_brute.png", category: "Hostile" },
  ...
  { id: "skeleton_wither", name: "Wither Skeleton", path: "skeleton/wither_skeleton.png", category: "Hostile" },
  ...
  { id: "zombie_villager", name: "Zombie Villager", path: "zombie_villager/zombie_villager.png", category: "Hostile" },
  ...
  { id: "cat_british", name: "British Shorthair", path: "cat/british_shorthair.png", category: "Passive" },
  ...
  { id: "mooshroom_brown", name: "Brown Mooshroom", path: "cow/brown_mooshroom.png", category: "Passive" },
  ...
  { id: "parrot_red_blue", name: "Red & Blue Parrot", path: "parrot/red_blue.png", category: "Passive" },
  ...
  { id: "parrot_yellow_blue", name: "Yellow & Blue Parrot", path: "parrot/yellow_blue.png", category: "Passive" },
  ...
  { id: "wandering_trader", name: "Wandering Trader", path: "wandering_trader/wandering_trader.png", category: "Passive" },
  ...
  { id: "zombified_piglin", name: "Zombified Piglin", path: "piglin/zombified_piglin.png", category: "Neutral" },
  { id: "polar_bear", name: "Polar Bear", path: "bear/polar.png", category: "Neutral" },
  { id: "snow_golem", name: "Snow Golem", path: "snow_golem/pumpkin_golem.png", category: "Neutral" },
  ...
  { id: "fish_tropical", name: "Tropical Fish", path: "fish/tropical_fish.png", category: "Aquatic" },
  ...
  { id: "enderdragon", name: "Ender Dragon", path: "enderdragon/ender_dragon.png", category: "Other" },
  { id: "end_crystal", name: "End Crystal", path: "end_crystal/end_crystal.png", category: "Other" },
...
export function getCategories(): IconCategory[] {
  return ICON_CATEGORIES.filter(cat =>
    ENTITY_ICONS.some(icon => icon.category === cat)
  );
}
...
export function searchIcons(query: string): EntityIcon[] {
  ...
  return ENTITY_ICONS.filter(icon =>
